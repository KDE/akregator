...
# if defined(MAKE_AKREGATORINTERFACES_LIB)
   /* We are building this library */
#  define AKREGATORINTERFACES_EXPORT KDE_EXPORT
# else
   /* We are using this library */
#  define AKREGATORINTERFACES_EXPORT KDE_IMPORT
# endif
#endif

# ifndef AKREGATORINTERFACES_EXPORT_DEPRECATED
#  define AKREGATORINTERFACES_EXPORT_DEPRECATED KDE_DEPRECATED AKREGATORINTERFACES_EXPORT
# endif
